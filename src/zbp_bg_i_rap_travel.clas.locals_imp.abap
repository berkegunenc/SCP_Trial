...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD calculateTotalPrice.
    MODIFY ENTITIES OF zbg_i_rap_travel IN LOCAL MODE
        ENTITY travel
  ...
  METHOD calculateTravelID.
    ...
    READ ENTITIES OF zbg_i_rap_travel IN LOCAL MODE
      ENTITY Travel
...
*                                          textid   = zbg_cm_rap=>agency_unknown
...
*      " Clear state messages that might exist
    ...
    DATA business_data TYPE TABLE OF zrapz_travel_agency_es5.
    ...
    IF  agencies IS NOT INITIAL.
      ...
      TRY.
          ...
          NEW zbgcl_ce_rap_agency( )->get_agencies(
            EXPORTING
...
**      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW zbg_cm_rap(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zbg_cm_rap=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zbg_cm_rap(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zbg_cm_rap=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zbg_cm_rap(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zbg_cm_rap=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
  ...
  METHOD get_authorizations.
    ...
    "We perform this for active (is_draft=00) as well as for drafts (is_draft=01) as we can't distinguish between edit or new drafts
    SELECT FROM zbg_rap_atrav
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky        = travel-%tky
                            %msg        = NEW zbg_cm_rap( severity = if_abap_behv_message=>severity-error
                                                            textid   = zbg_cm_rap=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
  ...
  METHOD is_create_granted.
    AUTHORITY-CHECK OBJECT 'ZBG_OSTAT'
      ID 'ZBG_OSTAT' DUMMY
      ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_delete_granted.
    IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZBG_OSTAT'
        ID 'ZBG_OSTAT' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZBG_OSTAT'
        ID 'ZBG_OSTAT' DUMMY
